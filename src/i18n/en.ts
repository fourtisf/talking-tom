...
export const EN = {
  ...
  'chat.hungry.3': 'I could eat. I could really eat.',
  'chat.hungry.4': 'Feed me and I will forget this ever happened.',
  'chat.tired.1': 'I need a nap. A long one.',
  'chat.tired.2': 'My eyes are doing the heavy thing.',
  'chat.tired.3': 'Bed. Please. Now-ish.',
  'chat.dirty.1': 'I have been rolling in something.',
  'chat.dirty.2': 'Do not look at my paws.',
  'chat.dirty.3': 'A bath. Fine. One bath.',
  'chat.bored.1': 'Entertain me.',
  'chat.bored.2': 'I have counted the tiles. Twice.',
  'chat.bored.3': 'Something should happen today.',
  'chat.bored.4': 'Play with me or I knock something over.',
  'chat.happy.1': 'This is a good day.',
  'chat.happy.2': 'Everything is exactly right.',
  'chat.happy.3': 'I like it here.',
  'chat.happy.4': 'Nothing to report. Purring.',
  'chat.happy.5': 'Best owner. Do not tell the others.',
  'chat.back.short.1': 'Oh. You came back.',
  'chat.back.short.2': 'I was NOT waiting by the door.',
  'chat.back.short.3': 'Where did you go for {hours} hours?',
  'chat.back.long.1': '{hours} hours. I counted every one.',
  'chat.back.long.2': 'You left. I coped. Barely.',
  'chat.back.long.3': 'I had opinions while you were out.',
  'chat.back.ages.1': 'I thought you moved away.',
  'chat.back.ages.2': 'It has been DAYS. I checked.',
  'chat.back.ages.3': 'I forgive you. It will cost you snacks.',
  'chat.dressed.1': 'How do I look?',
  'chat.dressed.2': 'This is my colour.',
  'chat.dressed.3': 'I am keeping this on forever.',
  'chat.dressed.4': 'Do not laugh.',
  'chat.fed.1': 'That hit the spot.',
  'chat.fed.2': 'More of that, please.',
  'chat.fed.3': 'You may continue.',
  'chat.washed.1': 'I am extremely clean now.',
  'chat.washed.2': 'Smell me. Go on.',
  'chat.washed.3': 'That was undignified. Worth it.',
  'chat.played.1': 'Again! Again!',
  'chat.played.2': 'Did you see me?',
  'chat.played.3': 'I am very good at that.',
  'chat.woke.1': 'Five more minutes.',
  'chat.woke.2': 'I was having a good dream.',
  'chat.woke.3': 'Morning. I suppose.',
  ...
  'tutorial.step3.body': 'Food feeds her, Bath cleans her, Sleep refills her Energy, Loo is where she needs to go, Style is her wardrobe, and Play holds the mini-games.',
  'tutorial.step4.title': 'This side is your stuff',
  'tutorial.step4.body': 'Tasks and Awards, the Shop, and a free video for coins. Tasks give you three jobs a day; Awards are milestones that never reset.',
  'tutorial.step5.title': 'Take her picture',
  'tutorial.step5.body': 'Dress her up, then tap the camera. It makes a card you can send to anyone — and the first one each day pays you coins.',
  'tutorial.step6.title': 'That is all of it',
  'tutorial.step6.body': 'Look after her, finish your tasks, and spend the coins on hats, outfits and a rug for her floor. Your first task is waiting.',
  'tutorial.next': 'NEXT',
  'tutorial.play': 'PLAY',
  'tutorial.skip': 'Skip',
