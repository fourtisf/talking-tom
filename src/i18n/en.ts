...
export const EN = {
  ...
  'tray.scrub.label': 'Scrub',
  'tray.scrub.caption': 'tap',
  'tray.rinse.label': 'Rinse',
  'tray.rinse.caption': 'tap',
  ...
  'home.toast.asleep': 'Biskit is asleep',
  'home.toast.full': 'Biskit is full',
  ...
  'home.return.title': 'Biskit missed you!',
  'home.return.body': 'You were away {duration}. Here\'s what changed:',
  'home.return.capped': 'Biskit dozed through the rest — no harm done.',
  ...
  /* ---- voice ---- */
  'voice.prompt.title': 'Let Biskit hear you',
  'voice.prompt.body': 'Say something and Biskit repeats it back in a silly voice. The recording stays on your device and is never uploaded.',
  'voice.prompt.confirm': 'Allow microphone',
  'voice.error.unsupported': 'This device can\'t record, but everything else still works.',
  'voice.error.permissionDenied': 'Allow the microphone to hear Biskit repeat you.',
  ...
  /* ---- task ---- */
  'task.feed3.one': 'Feed Biskit {n} time',
  'task.feed3.other': 'Feed Biskit {n} times',
  'task.scrub2.one': 'Give Biskit {n} bath',
  'task.scrub2.other': 'Give Biskit {n} baths',
  'task.pet10.one': 'Pet Biskit {n} time',
  'task.pet10.other': 'Pet Biskit {n} times',
  'task.voice1.one': 'Make Biskit repeat you',
  'task.voice1.other': 'Make Biskit repeat you',
  'task.catch8.one': 'Catch {n} treat in Play',
  'task.catch8.other': 'Catch {n} treats in Play',
  'task.sleep1.one': 'Tuck Biskit into bed',
  'task.sleep1.other': 'Tuck Biskit into bed',
